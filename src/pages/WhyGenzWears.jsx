...
export default function WhyGenzWears() {
  return (
    // No background of its own on purpose — the globally-mounted CosmicDust
    // canvas (src/components/CosmicDust.jsx, position:fixed z-index:-1 in
    // App.jsx) shows through as this page's background.
